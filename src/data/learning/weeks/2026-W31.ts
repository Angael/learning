...
export const week2026W31: ILearningWeek = {
  ...
  coverage: [
    'C# 010 closed correctly; C# 011 now contrasts a deferred IEnumerable<T> query with List<T> snapshots made at two different reads.',
  ...
  backlog: [
    'Open: [learn:csharp/011:q1], [learn:csharp/012:q1], [learn:dotnet/010:q1], [learn:dotnet/011:q1], [learn:german/009:q1], and [learn:german/010:q1]. Each topic is now at the two-open-task limit, so no further reply-required work should publish until a task closes in that topic.',
  ],
  outlook: [
    ...
    'German: use German 009 and 010 evidence to choose a focused Perfekt repair, another guided chat step, or a deliberate pause.',
  ],
  archive: 'Week 2026-W31 now contains seven evidence-led sessions. C# moved from nominal contracts through LINQ and into a first Task<T>/await boundary. .NET moved from status tests to an API-visible created-resource check and then to a safe structured log event; the duplicate persistence-boundary candidate stayed dropped. German 008 closed, German 009 adds spaced Perfekt retrieval, and German 010 begins a tightly guided social chat. Every topic is at the two-open-task limit. No future publication dates are assigned.',
};
