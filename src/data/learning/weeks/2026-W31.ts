...
export const week2026W31: ILearningWeek = {
  ...
  backlog: [
    'Open: [learn:csharp/012:q1], [learn:dotnet/010:q1], [learn:dotnet/011:q1], [learn:german/009:q1], and [learn:german/010:q1]. .NET and German remain at the two-open-task limit; C# has room only if the C# 012 evidence makes another reply-required task worthwhile.',
  ],
  outlook: [
