...
Published on 2026-07-05. This lesson teaches that C# `var` is compile-time static type inference, not JavaScript-style dynamic binding. It covers integer division, numeric literal defaults, `int`, `double`, `float`, `decimal`, and why `decimal * double` is a compile-time error.
